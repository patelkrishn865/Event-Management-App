    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="mx-auto max-w-6xl px-6 py-8 space-y-6">
                        ...
                        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Button
                                    variant="outline"
                                    className="rounded-2xl bg-background/55"
                                    // TODO: Create Admin version of Attendees page
                                    onClick={() =>
                                ...
                                <Button
                                    variant="outline"
                                    className="rounded-2xl bg-background/55"
                                    // TODO: Create Admin version of Feedback page
                                    onClick={() =>
                ...
                {/* Overview */}
                {activeTab === "overview" && (
                    <div className="grid p-0 gap-4 lg:grid-cols-3">
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        >
                                                            ...
                                                            <SelectContent>
                                                                {["Music", "Technology", "Business", "Workshop", "Party", "Arts", "Sports", "Other"].map((c) => (
